...
public class TrelloAccountBoardPage {
	...
	private WebElement accountMebuLogoutOption;

	public WebElement accountMebuLogoutOption() {
		return accountMebuLogoutOption;
	}
	...
	public WebElement selectBoardOnAccountPage(String readStringData) {
